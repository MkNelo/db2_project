...
var $author$project$Icons$svgFeatherIcon = F3(
	function (h, w, className) {
...
var $author$project$Icons$award = A4(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('upper-o'),
						$elm$html$Html$Attributes$class('overlay d-flex flex-column bg-transparent align-items-center justify-content-center position-fixed')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$class('p-2 btn bg-transparent rounded-circle p-0')
							]),
						_List_fromArray(
							[
								$author$project$Icons$playCircle('rounded-circle m-0 hover-play')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('p-2 h4 text-light')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Iniciar Simulación')
							]))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('overlay alpha position-fixed')
					]),
				_List_Nil),
				A2(
				$elm$html$Html$img,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('img-thumbnail rounded-0'),
						$elm$html$Html$Attributes$src('https://www.honeybells.co.uk/assets/images/event-le-mans-24-hour-glamping.jpg')
					]),
				_List_Nil),
				A2(
				$elm$html$Html$div,
...
var $author$project$Icons$menu = A4(
	$author$project$Icons$svgFeatherIcon,
	'24',
	'24',
	'menu',
...
var $author$project$Navbar$toggler = F2(
	function (className, childs) {
		return A2(
			$elm$html$Html$button,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class(className),
					$elm$html$Html$Attributes$id('toggler')
				]),
			childs);
	});
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('d-flex w-100 h-100')
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('page-canvas'),
